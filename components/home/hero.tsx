      ...
      <div className="relative z-10 mx-auto grid max-w-6xl items-start gap-5 px-6 py-6 sm:gap-8 sm:py-10 lg:grid-cols-[minmax(0,1fr)_minmax(20rem,32rem)] lg:gap-12 lg:py-16">
        <div className="min-w-0">
          <p className="text-sm font-medium text-orange-300">
            SWMS and compliance docs
          </p>
          <h1 className="mt-2 max-w-[18ch] text-balance font-display text-[1.75rem] font-extrabold leading-tight tracking-tight text-white sm:mt-3 sm:text-4xl lg:text-5xl">
        ...
        <div className="min-w-0">
          <p className="mb-4 hidden max-w-xl text-sm leading-relaxed text-slate-400 sm:block">
            When the builder wants a SWMS before you start, open the pack, add
            the site, print. {writtenCount} free written guides sit alongside
            the templates. Checkout is not live yet.
          </p>
